...
public class InstantaDisciplina {
    ...
    public InstantaDisciplina(int id_instanta_disciplina, int id_disciplina, int id_profesor, int id_an_universitar, int nr_credite, int semestru) {
    ...
    public boolean equals(Object o) {
        ...
        InstantaDisciplina that = (InstantaDisciplina) o;
